...
import com.example.poc.SlideBarActivity;
    ...
    private void handleClient(Socket clientSocket) {
        ...
        try {
            ...
            while(true) {
                ...
                SlideBarActivity.OtherUser(receivedData);
                Log.println(Log.INFO, "SocketServer", "Received: " + receivedData);
                byte[] sendMessage = String.valueOf(SlideBarActivity.GetProgress()).getBytes(StandardCharsets.US_ASCII);
